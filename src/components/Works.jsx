      ...
      >
        <div className="relative w-full h-[230px]">
          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            <div
              onClick={() => window.open(source_deploy_link, "_blank")}
    ...
    <>
      ...
      <div className="w-full flex">
        ...
        >
          ...
          through concrete examples of my work. Each project is briefly
          described and includes links to code repositories and live demos.
          These examples showcase my ability to tackle complex problems, work
